...
$_['heading_title']              = 'Заказы';
            ...
            $_['entry_date_added_start']             = 'Добавлены с';
            $_['entry_date_added_end']             = 'Добавлены до';
            $_['entry_load_to_excel']             = 'Сохранить в Excel';
            $_['error_select_date']             = 'Необходимо выбрать дату';
            $_['entry_excel_order_id']             = 'Номер заказа';
            $_['entry_excel_added_date']             = 'Дата заказа';
            $_['entry_excel_name']             = 'Имя и фамилия';
            $_['entry_excel_address']             = 'Адрес доставки';
            $_['entry_excel_products']             = 'Товары в заказеы';
            $_['entry_excel_summ']             = 'Сумма заказа';
