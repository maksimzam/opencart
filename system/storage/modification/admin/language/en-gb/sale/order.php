...
$_['heading_title']              = 'Orders';
            ...
            $_['entry_date_added_start']             = 'From';
            $_['entry_date_added_end']             = 'To';
            $_['entry_load_to_excel']             = 'Save Excel';
            $_['error_select_date']             = 'Please select date';

            $_['entry_excel_order_id']             = 'Order #';
            $_['entry_excel_added_date']             = 'Date';
            $_['entry_excel_name']             = 'Name';
            $_['entry_excel_address']             = 'Address';
            $_['entry_excel_products']             = 'Products';
            $_['entry_excel_summ']             = 'Total';
